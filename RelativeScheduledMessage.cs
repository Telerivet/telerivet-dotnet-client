...
public class RelativeScheduledMessage : Entity
{
    /**
    ...
    */
    ...
    {
        return "/projects/" + ProjectId + "/relative_scheduled/" + Id + "";
    }

    public RelativeScheduledMessage(TelerivetAPI api, JObject data, bool isLoaded = true)
